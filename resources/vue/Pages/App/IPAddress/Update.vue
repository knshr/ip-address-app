    ...
    >
        <q-card style="width: 300px">
            <q-card-section class="bg-primary text-white">
                <div class="text-h6">{{ $t("label.edit.ip.address") }}</div>
            </q-card-section>
            ...
            <q-card-section>
                <q-input
                    ...
                    class="q-pa-md"
                    dense
                    v-model="ipAddress.form.ip_address"
            ...
            <q-card-actions align="right">
                <q-btn
                    ...
                    @click="ipAddress.toggleEditModal"
                ></q-btn>
                <q-btn
                    color="primary"
                    class="q-ml-xs"
